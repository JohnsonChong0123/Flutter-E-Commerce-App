...
android {
    namespace = "com.example.e_commerce_client"
    ...
    defaultConfig {
        ...
        applicationId = "com.example.e_commerce_client"
        ...
        val facebookAppId: String =
            if (project.hasProperty("FACEBOOK_APP_ID")) project.property("FACEBOOK_APP_ID") as String
            else ""
